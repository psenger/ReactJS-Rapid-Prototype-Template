...
describe('I18N: ', () => {
    describe('i18m.js', () => {
        ...
        it('should return a string with context and pluralisation expanded', () => {
            expect( i18n.translate('%{name} uploaded %n photos to their %{album} album',100,{name:'Larry',album:'family'},{gender:'male'}) ).to.equal('Larry uploaded 100 photos to his family album');
        });
        it('should return string defaulted when the context is not found.', () => {
            expect( i18n.translate('%{name} uploaded %n photos to their %{album} album',100,{name:'Sue',album:'family'},{gender:'girl'}) ).to.equal('Sue uploaded 100 photos to their family album');
        });
    })
});
