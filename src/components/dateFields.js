...
export default class DateFields extends Component {
   ...
   * @returns {function(this:DateFields)} binds to this.
   */
        ...
        <div className="container-fluid" style={{padding: 0}}>
          <div className="row">
            <div className="col-xs-4">
              <ControlLabel srOnly htmlFor={this.props.fieldId + '_day'}>Day of the month of the birth
                day</ControlLabel>
              <FormControl type="number"
                           ...
                           tabIndex="0"/>
              <div className="row">
                <div className="col-xs-12"><HelpBlock id={this.props.fieldId + '_help_day'}
                                                      role="tooltip">Day</HelpBlock></div>
              </div>
            </div>
            <div className="col-xs-4">
              ...
              <FormControl type="number"
                           ...
                           tabIndex="0"/>
              <div className="row">
                <div className="col-xs-12"><HelpBlock id={this.props.fieldId + '_help_month'}
                                                      role="tooltip">Month</HelpBlock></div>
              </div>
            </div>
            <div className="col-xs-4">
              ...
              <FormControl type="number"
                           ...
                           tabIndex="0"/>
              <div className="row">
                <div className="col-xs-12"><HelpBlock id={this.props.fieldId + '_help_year'}
                                                      role="tooltip">Year</HelpBlock></div>
              </div>
            </div>
          </div>
        </div>
